...
## 🧠 The Problem: A New Generation of Cyber Threats

Traditional security tools like firewalls and antivirus software are **blind** to a new, sophisticated threat vector — adversarial attacks on AI models.  
...
> 💡 You can capture and display a screenshot of your application here.
...
### 🔹 Interactive UI
A professional, dark-themed interface designed for easy drag‑and‑drop file analysis.

### 🔹 Statistical Anomaly Detection
Aura’s **first line of defense**. It performs statistical analysis on incoming data to immediately flag and block low‑complexity attacks like random noise or malformed inputs.

### 🔹 Confidence Volatility Analysis (Core Innovation)
Aura’s **primary defense mechanism**. It probes the AI model’s stability by introducing minor _perturbations_ in the input data.

- **Benign Inputs:** Cause minimal change in the model’s confidence.
